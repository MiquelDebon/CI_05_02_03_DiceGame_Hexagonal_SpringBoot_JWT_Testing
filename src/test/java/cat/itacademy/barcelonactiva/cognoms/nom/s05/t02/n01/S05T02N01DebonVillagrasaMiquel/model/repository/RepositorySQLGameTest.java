...
//    Game gameMySQL_1 = new Game(10, playerMySQL1);
//    Game gameMySQL_2 = new Game(7, playerMySQL1);
//    Game gameMySQL_3 = new Game(3, playerMySQL2);
//
//
//    @AfterEach
...
//
//        Game savedGame = gameMySQLRepository.save(gameMySQL_1);
//        List<Game> list = gameMySQLRepository.findAll();
//
...
//
//        Game game = gameMySQLRepository.findById(id).get();
//
...
//        gameMySQLRepository.save(gameMySQL_1);
//        List<Game> previousList = gameMySQLRepository.findAll();
//
//        gameMySQLRepository.deleteById(gameMySQL_1.getId());
//        List<Game> postList = gameMySQLRepository.findAll();
//
...
//
//        List<Game> list1Game = gameMySQLRepository.findByPlayerId(playerMySQL1.getId());
//        List<Game> list2Game = gameMySQLRepository.findByPlayerId(playerMySQL2.getId());
//
...
//        gameMySQLRepository.save(gameMySQL_3);    //player2
//
//        List<Game> previousList_1 = gameMySQLRepository.findByPlayerId(playerMySQL1.getId());
//        List<Game> previousList_2 = gameMySQLRepository.findByPlayerId(playerMySQL2.getId());
//
//        gameMySQLRepository.deleteByPlayerId(playerMySQL1.getId());
//        gameMySQLRepository.deleteByPlayerId(playerMySQL2.getId());
//        List<Game> postList_1 = gameMySQLRepository.findByPlayerId(playerMySQL1.getId());
//        List<Game> postList_2 = gameMySQLRepository.findByPlayerId(playerMySQL2.getId());
//
//
